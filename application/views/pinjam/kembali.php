			    ...
			    <div class="box-body">
                        ...
                        <div class="pull-right">
							<a data-toggle="modal" data-target="#TableDenda" class="btn btn-primary btn-md" style="margin-left:1pc;">
								<i class="fa fa-sign-in"></i> Return</a>
...
<h4 class="modal-title"> Book Returns</h4>
</div>
<div id="modal_body" class="modal-body fileSelection1">
	<table class="table table-striped">
		<tr style="background:yellowgreen">
			<td colspan="3">Book Borrowing Data</td>
		</tr>
		<tr>
			<td>No Borrowing</td>
			<td>:</td>
...
<div class="modal-footer">
	<div class="pull-right">
		...
		<button class="btn btn-primary"> Returns Process</button></a>
