							...
							<div class="col-sm-5">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<div id="result_tunggu"> <p style="color:red">* No Results Yet</p></div>
											<div id="result"></div>
										</td>
									</tr>
									<tr>
							...
							<div class="col-sm-7">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<div id="result_tunggu_buku"> <p style="color:red">* No Results Yet</p></div>
		...
		<?php $no=1;foreach($buku->result_array() as $isi){?>
			<tr>
				...
				<a href="<?= base_url('data/bukudetail/'.$isi['id_buku']);?>" target="_blank">
					<button class="btn btn-success"><i class="fa fa-sign-in"></i> Details</button></a>
				</td>
			</tr>
		<?php $no++;}?>
		</tbody>
