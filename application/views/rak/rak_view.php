					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/rakproses');?>">
								...
								<label for="">Shelf Name / Location</label>
								...
								<button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> Edit Shelf</button>
							</form>
							<?php }else{?>
							...
							<form method="post" action="<?= base_url('data/rakproses');?>">
								...
								<button type="submit" class="btn btn-primary"> <i class="fa fa-plus"></i> Add Shelves</button>
							</form>
							<?php }?>
						</div>
					</div>
